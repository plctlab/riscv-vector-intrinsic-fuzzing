...
static std::string getVectorFromConstant(std::ostream &os, int constant,
  ...
  os << " // generated by library/Operator.cpp getVectorFromConstant\n"
     << typeInfo.vectorTypeName << " " << result
...
static std::string getVectorFromVector(std::ostream &os,
                                       ...
                                       const TypeInfo &typeInfo) {
  std::string result = getNewPlaceholderName();
  os << " // generated by library/Operator.cpp getVectorFromVector\n"
     << typeInfo.vectorTypeName << " " << result << " = __riscv_vmv_v_v_"
...
std::string loadOneDToVector(std::ostream &os, ValueBase *value,
  ...
  if (value->type == CustomValType::OneDBool) {
    ...
    os << "\t" << typeInfo.vectorTypeName << " " << resultVec
       << " = __riscv_vle" << typeInfo.sew.to_string() << "_v_"
       << typeInfo.shortVectorTypeName << "(" << holder << ", vl);\n";
  }
  return resultVec;
}
...
static void genReductionOpString(std::ostream &os, OperatorBase *op,
  ...
  os << "// generated by genReductionOpString\n\t";
...
static void storeVectorToScalar(std::ostream &os, const std::string rawBase,
                                ...
                                const TypeInfo &typeInfo) {
  os << "// generated by library/Operator.cpp storeVectorToScalar\n\t"
     << "*" << rawBase << "= "
